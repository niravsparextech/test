...
/**
 * AvailableCarrierWillPickUpOptionsList Class Doc Comment.
 *
...
class AvailableCarrierWillPickUpOptionsList implements ModelInterface, ArrayAccess, IterableType
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'AvailableCarrierWillPickUpOptionsList';
    ...
    {
        return AvailableCarrierWillPickUpOption::class;
    }
}
